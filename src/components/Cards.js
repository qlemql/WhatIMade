            ...
            <div className="cards__container">
                <div className="cards__wrapper">
                    ...
                    <ul className="cards__items">
                        ...
                        <CardItem src="images/img-4.jpg" text="Ride through the Sahara Desert on a guded camel tour" label="Adventure" path="/products" />
                        <CardItem src="images/img-8.jpg" text="Experience Football on Top of the Himilayan Mountains" label="Adrenaline" path="/sign-up" />
                    </ul>
                </div>
            </div>
        </div>
